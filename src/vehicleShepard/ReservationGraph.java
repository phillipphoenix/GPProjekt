...
public class ReservationGraph extends JPanel {
	...
	public void paintComponent(Graphics gSimple) {
		...
		GregorianCalendar sCal = new GregorianCalendar(selectedYear, selectedMonth, 1);
		...
		for(ArrayList<Reservation> vehicleRes : allRes) {
			...
			for(Reservation r : vehicleRes) {
				GregorianCalendar ca = new GregorianCalendar(r.getFromDateYear(), r.getFromDateMonth(), r.getFromDateDay());
				if(1 == 1) {
